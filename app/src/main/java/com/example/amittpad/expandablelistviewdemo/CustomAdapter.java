...
/**
 * Created by Amit TPAD on 6/29/2017.
 */
...
//        sequence.setText(detailInfo.getSequence().trim() + ". ");
        TextView childItem = (TextView) view.findViewById(R.id.child_item);
    ...
    public View getGroupView(int groupPosition, boolean isLastChild, View view,
        ...
        TextView heading = (TextView) view.findViewById(R.id.heading_item);
